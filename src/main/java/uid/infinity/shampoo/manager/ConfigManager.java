...
import uid.infinity.shampoo.features.settings.EnumConverter;
...
public class ConfigManager {
    private static final Path OYVEY_PATH = FabricLoader.getInstance().getGameDir().resolve("shampoo");
    private static final Gson gson = new GsonBuilder()
            .setPrettyPrinting()
            .create();
    private final List<Jsonable> jsonables = List.of(shampoo.friendManager, shampoo.moduleManager, shampoo.commandManager);
    ...
    public static void setValueFromJson(Feature feature, Setting setting, JsonElement element) {
        ...
        switch (setting.getType()) {
            ...
            default -> {
                shampoo.LOGGER.error("Unknown Setting type for: " + feature.getName() + " : " + setting.getName());
            }
        }
    }
