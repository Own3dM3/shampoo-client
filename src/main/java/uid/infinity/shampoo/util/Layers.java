...
import static uid.infinity.shampoo.util.Pipelines.*;

public class Layers {
    private static final RenderLayer GLOBAL_QUADS;
    private static final RenderLayer GLOBAL_TRIANGLES;
    ...
    public static RenderLayer getGlobalTriangles(){
    ...
    static {
        ...
        GLOBAL_TRIANGLES = RenderLayer.of(
                "global_triangles",
                256,
                GLOBAL_TRIANGLES_PIPELINE,
                empty()
        );
    }

    public static Graphics2D getGlobalTriangleStrip() {
        return null;
    }
}