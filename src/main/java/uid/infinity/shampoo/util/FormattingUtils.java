...
import uid.infinity.shampoo.mixin.StyleAccessor;
import uid.infinity.shampoo.mixin.TextColorAccessor;
...
public class FormattingUtils implements Util {
    ...
    public static Style withExclusiveFormatting(Style style, CustomFormatting formatting) {
        ...
        if (formatting == CustomFormatting.CLIENT) {
            textColor = TextColorAccessor.create(shampoo.colorManager.getColor().getRGB(), "CLIENT");
