package uid.infinity.shampoo.features.modules;
...
import uid.infinity.shampoo.features.modules.client.Notifications;
import uid.infinity.shampoo.features.settings.Bind;
import uid.infinity.shampoo.features.settings.Setting;
import uid.infinity.shampoo.manager.ConfigManager;
...
public class Module extends Feature implements Jsonable {
    ...
    public void enable() {
        ...
        this.onToggle();
        this.onEnable();
        if (shampoo.moduleManager.getModuleByClass(Notifications.class).isEnabled()) {
            Command.sendMessage1(ChatUtil.getClient()  + shampoo.commandManager.getClientMessage()+ " " + Formatting.WHITE + this.getDisplayName() + Formatting.GREEN + " on");
        }
    ...
    public void disable() {
        ...
        if (shampoo.moduleManager.getModuleByClass(Notifications.class).isEnabled()) {
            Command.sendMessage1(ChatUtil.getClient() + shampoo.commandManager.getClientMessage() + " " + Formatting.WHITE + this.getDisplayName()  + Formatting.RED + " off");
        }
        this.onToggle();
        this.onDisable();
    }
    ...
    public void setDisplayName(String name) {
        Module module = shampoo.moduleManager.getModuleByDisplayName(name);
        Module originalModule = shampoo.moduleManager.getModuleByName(name);
