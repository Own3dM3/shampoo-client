...
public class EntityControl extends Module {
    ...
    public EntityControl() {
        super("EntityControl", "Allows full manual control over boats and horses, including vertical movement and gravity cancellation", Category.MOVEMENT, true, false, false);
    }
